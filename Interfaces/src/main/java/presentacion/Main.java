...
import co.com.hyunseda.market.access.UserRepository;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ListaProductosGUI instance = new ListaProductosGUI(categoryService, productService, shoppingCartService,orderService,userService);
