...
public class ListaProductosGUI extends javax.swing.JFrame implements Observer {
    ...
    public ListaProductosGUI(CategoryService categoryService,ProductService productService, 
    ...
    private void initComponents() {
        ...
        btnAniadirProducto.setText("Log In");
    ...
    private void btnAniadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAniadirActionPerformed
        if(products.get(lstProductos.getSelectedIndex()).getStock()>0){
            Long id = products.get(lstProductos.getSelectedIndex()).getId();
    ...
    private void btnAniadirProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAniadirProductoActionPerformed
        ...
        LoginGUI instance = new LoginGUI(categoryService,productService,orderService,userService,this);
        instance.setVisible(true);
